                                    ...
                                    <form class="js-validation-signup" action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="py-3">
                                            ...
                                            <div class="form-group">
                                                <input id="last_name" type="text" class="form-control form-control-lg form-control-alt @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}" autocomplete="last_name" autofocus placeholder="last_name">
                                            ...
                                            <div class="form-group">
                                                <input id="first_name" type="text" class="form-control form-control-lg form-control-alt @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name') }}" autocomplete="first_name" autofocus placeholder="first_name">
                                            ...
                                            <div class="form-group">
                                                <input id="signup-email" type="email" class="form-control form-control-lg form-control-alt @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" autocomplete="email" placeholder="Email">
                                                @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="form-group">
                                               <input id="password" type="password" class="form-control form-control-lg form-control-alt @error('password') is-invalid @enderror" name="password" autocomplete="new-password" placeholder="Password">
                                               @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="form-group">
                                                <input id="password-confirm" type="password" class="form-control form-control-lg form-control-alt" name="password_confirmation" autocomplete="new-password" placeholder="Password Confirm">
                                            ...
                                            <div class="form-group">
                                                <select name="profile_type" id="cars" class="form-control form-control-lg form-control-alt @error('profile_type') is-invalid @enderror">
                                               ...
                                               @error('profile_type')
                                                ...
                                                @enderror
                                                {{-- <input type="password" class="form-control form-control-lg form-control-alt" id="profile_type" name="profile_type" placeholder="profile_type"> --}}
                                            </div>
                                            ...
                                            <div class="form-group">
                                               ...
                                               @error('gender')
                                                ...
                                                @enderror
                                                {{-- <input type="password" class="form-control form-control-lg form-control-alt" id="gender" name="gender" placeholder="gender"> --}}
                                            </div>

                                            <div class="form-group">
                                                <input id="dob" type="date" class="form-control form-control-lg form-control-alt @error('dob') is-invalid @enderror" name="dob" value="{{ old('dob') }}" autocomplete="dob" placeholder="date of birth">
                                                @error('dob')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                                @enderror
                                                {{-- <input type="dob" class="form-control form-control-lg form-control-alt" id="dob" name="dob" placeholder="Email"> --}}
                                            </div>

                                            <div class="form-group">
                                                <input id="username" type="text" class="form-control form-control-lg form-control-alt @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" autocomplete="username" placeholder="username">
                                                @error('username')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                                @enderror
                                                {{-- <input type="username" class="form-control form-control-lg form-control-alt" id="username" name="username" placeholder="Email"> --}}
                                            </div>
